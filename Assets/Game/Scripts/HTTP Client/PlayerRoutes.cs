...
public class PlayerRoutes
{
    ...
    public static PlayerRoutes GetInstance(CubeJumpHTTPClient client)
    {
    ...
    private PlayerRoutes(CubeJumpHTTPClient client)
    {
        this.client = client;
    }
    ...
    {
        string url = client.baseUrl + "cj_player_routes/save_player_data";
    ...
    {
        string url = client.baseUrl + "cj_player_routes/load_player_data";
    ...
    {
        string url = client.baseUrl + "cj_player_routes/save_leaderboard_data";
    ...
    {
        string url = client.baseUrl + "cj_player_routes/get_leaderboard" + queryString;
